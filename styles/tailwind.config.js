module.exports = {
  ...
  theme: {
    ...
    boxShadow: {
      "inset-stroke": "0px 0px 0px 0.6px inset rgba(0, 0, 0, 0.17)",
      "applet-header":
        "0px 1px 1px 0px hsla(var(--shadow-color) / 0.07), 0px 1px 1px 0px rgba(var(--clr-solid), 0.25), 0px 0px 0px 0.6px hsla(var(--shadow-color) / 0.3)",
      "btn-basic":
        "0px 1px 1px hsla(var(--shadow-color) / 0.40), 0px 0px 0px 0.6px hsla(var(--shadow-color) /  0.40)",
      "btn-basic-inset":
        "0px 1px 1px inset hsla(var(--shadow-color) / 0.2), 0px 0px 0px 0.6px hsla(var(--shadow-color) / 0.40)",
      "list-inset": "0px 1px 1px inset hsla(var(--shadow-color) / .5)",
      "btn-highlight":
        "0px 0px 0px 0.6px #005CAF, 0px 1px 1px rgba(0, 0, 0, 0.07)",
      topbar:
        "0px 1px 1px hsla(var(--shadow-color) / 0.40), 0px 1px 40px 0px rgba(var(--clr-solid), 0.15), 0px 0px 0px 0.6px hsla(var(--shadow-color) / 0.4)",
      body: "0px 0px 40px 0px inset rgba(var(--clr-solid), 0.15)",
