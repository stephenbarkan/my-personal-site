module.exports = {
  ...
  theme: {
    ...
    boxShadow: {
      ...
      "list-inset": "0px 1px 1px inset hsla(var(--shadow-color) / .3)",
      "btn-highlight":
        "0px 0px 0px 0.6px #005CAF, 0px 1px 1px rgba(0, 0, 0, 0.07)",
      topbar:
        "0px 1px 1px hsla(var(--shadow-color) / 0.40), 0px 1px 40px 0px rgba(var(--clr-solid), 0.10), 0px 0px 0px 0.6px hsla(var(--shadow-color) / 0.4)",
